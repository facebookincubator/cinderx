...
def main(opcode_py, cinderx_opcode_py, outfile='Include/opcode.h',
    ...
    with open(outfile, 'w') as fobj, open(internaloutfile, 'w') as iobj, open(
        ...
        write_int_array_from_ops("_CiOpcode_Jump", opcode['hasjrel'] + opcode['hasjabs'], iobj)
        ...
        iobj.write(f"static const char *const _CiOpcode_OpName[{NUM_OPCODES}] = {{\n")
        ...
        iobj.write("\n")
        iobj.write("#define Ci_EXTRA_CASES \\\n")
