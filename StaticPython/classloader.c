...
PyObject *
_PyClassLoader_GetModuleAttr(PyObject *module, PyObject *name)
{
...
static PyObject *
resolve_module(PyThreadState* tstate, PyObject *module_name)
{
...
PyMethodDescrObject* _PyClassLoader_ResolveMethodDef(PyObject* path) {
  ...
  if (cur == NULL) {
    ...
    return NULL;
      ...
      classloader_verify_type((PyObject*)target_type, path) ||
