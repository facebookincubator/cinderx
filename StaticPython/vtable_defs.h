...
void _PyVTable_func_lazyinit_dont_bolt(void);
void _PyVTable_thunk_ret_primitive_not_jitted_dont_bolt(void);
void _PyVTable_coroutine_classmethod_dont_bolt(void);
void _PyVTable_coroutine_property_dont_bolt(void);
void _PyVTable_coroutine_dont_bolt(void);
void _PyVTable_nonfunc_property_dont_bolt(void);
void _PyVTable_func_overridable_dont_bolt(void);
void _PyVTable_classmethod_overridable_dont_bolt(void);
void _PyVTable_nonfunc_dont_bolt(void);
void _PyVTable_staticmethod_dont_bolt(void);
void _PyVTable_classmethod_dont_bolt(void);
void _PyVTable_thunk_vectorcall_only_dont_bolt(void);
void _PyVTable_descr_dont_bolt(void);
void _PyVTable_func_missing_dont_bolt(void);
#ifdef __cplusplus
}
#endif
