...
int NativeGenerator::allocateHeaderAndSpillSpace(const FrameInfo& frame_info) {
  ...
  arch::sub_immediate(as_, a64::sp, a64::sp, static_cast<uint64_t>(frame_info.header_and_spill_size + padding));
...
void NativeGenerator::saveCallerRegisters(
  ...
  if (frame_info.arg_buffer_size > 0) {
    ...
    arch::sub_immediate(as_, a64::sp, a64::sp, static_cast<uint64_t>(frame_info.arg_buffer_size));
  }
#else
  CINDER_UNSUPPORTED
#endif
...
void NativeGenerator::setupFrameAndSaveCallerRegisters(
  ...
  arch::sub_immediate(as_, a64::sp, a64::sp, static_cast<uint64_t>(frame_info.header_and_spill_size));
#else
  CINDER_UNSUPPORTED
#endif
...
void NativeGenerator::generateEpilogue(BaseNode* epilogue_cursor) {
  ...
  if (!saved_regs.Empty()) {
    ...
    arch::add_signed_immediate(as_, a64::sp, arch::fp, -env_.last_callee_saved_reg_off);
