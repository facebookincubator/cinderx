...
static void ASMJIT_NOINLINE testA64AssemblerRel(AssemblerTester<a64::Assembler>& tester) noexcept {
  ...
  TEST_INSTRUCTION("010000101F2003D5", adr(x1, L0));
  TEST_INSTRUCTION("00000014", b(L0));
  TEST_INSTRUCTION("00000014", b_al(L0));
  TEST_INSTRUCTION("000000541F2003D5", b_eq(L0));
  TEST_INSTRUCTION("010000541F2003D5", b_ne(L0));
  TEST_INSTRUCTION("020000541F2003D5", b_hs(L0));
  TEST_INSTRUCTION("030000541F2003D5", b_lo(L0));
  TEST_INSTRUCTION("040000541F2003D5", b_mi(L0));
  TEST_INSTRUCTION("050000541F2003D5", b_pl(L0));
  TEST_INSTRUCTION("060000541F2003D5", b_vs(L0));
  TEST_INSTRUCTION("070000541F2003D5", b_vc(L0));
  TEST_INSTRUCTION("080000541F2003D5", b_hi(L0));
  TEST_INSTRUCTION("090000541F2003D5", b_ls(L0));
  TEST_INSTRUCTION("0A0000541F2003D5", b_ge(L0));
  TEST_INSTRUCTION("0B0000541F2003D5", b_lt(L0));
  TEST_INSTRUCTION("0C0000541F2003D5", b_gt(L0));
  TEST_INSTRUCTION("0D0000541F2003D5", b_le(L0));
  TEST_INSTRUCTION("00000014", b(CondCode::kAL, L0));
  TEST_INSTRUCTION("000000541F2003D5", b(CondCode::kEQ, L0));
  TEST_INSTRUCTION("010000541F2003D5", b(CondCode::kNE, L0));
  TEST_INSTRUCTION("020000541F2003D5", b(CondCode::kHS, L0));
  TEST_INSTRUCTION("030000541F2003D5", b(CondCode::kLO, L0));
  TEST_INSTRUCTION("040000541F2003D5", b(CondCode::kMI, L0));
  TEST_INSTRUCTION("050000541F2003D5", b(CondCode::kPL, L0));
  TEST_INSTRUCTION("060000541F2003D5", b(CondCode::kVS, L0));
  TEST_INSTRUCTION("070000541F2003D5", b(CondCode::kVC, L0));
  TEST_INSTRUCTION("080000541F2003D5", b(CondCode::kHI, L0));
  TEST_INSTRUCTION("090000541F2003D5", b(CondCode::kLS, L0));
  TEST_INSTRUCTION("0A0000541F2003D5", b(CondCode::kGE, L0));
  TEST_INSTRUCTION("0B0000541F2003D5", b(CondCode::kLT, L0));
  TEST_INSTRUCTION("0C0000541F2003D5", b(CondCode::kGT, L0));
  TEST_INSTRUCTION("0D0000541F2003D5", b(CondCode::kLE, L0));

  TEST_INSTRUCTION("00000094", bl(L0));
  TEST_INSTRUCTION("010000341F2003D5", cbz(w1, L0));
  TEST_INSTRUCTION("010000B41F2003D5", cbz(x1, L0));
  TEST_INSTRUCTION("010000351F2003D5", cbnz(w1, L0));
  TEST_INSTRUCTION("010000B51F2003D5", cbnz(x1, L0));
  TEST_INSTRUCTION("010018371F2003D5", tbnz(w1, 3, L0));
  TEST_INSTRUCTION("010008B71F2003D5", tbnz(x1, 33, L0));
  TEST_INSTRUCTION("010018361F2003D5", tbz(w1, 3, L0));
  TEST_INSTRUCTION("010008B61F2003D5", tbz(x1, 33, L0));
}
