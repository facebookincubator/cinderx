...
import __static__
from __static__ import box, cast, cbool, CheckedList, clen, inline, int64
...
class UrnaryConstraint(Constraint):
    ...
    def choose_method(self, mark: int64) -> None:
        if self.my_output.mark != mark and stronger(
...
class Planner:
    ...
    def extract_plan_from_constraints(
        self, constraints: CheckedList[UrnaryConstraint]
    ) -> Plan:
    ...
    def add_constraints_consuming_to(
        self, v: Variable, coll: CheckedList[Constraint]
    ) -> None:
        determining = v.determined_by
        cc = v.constraints
