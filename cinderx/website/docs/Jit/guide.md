---
title: JIT Dev Guide
description: "A high-level tour of the CinderX JIT: how the compiler pipeline fits together and where to look in the source."
sidebar_label: Dev Guide
slug: /jit/internals/dev-guide
---
...
[Jit/pyjit.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/pyjit.cpp). Use the option `-X cinderx-jit-help` for an
...
[Jit/pyjit.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/pyjit.cpp) and related functions.
...
`outputType()` in [Jit/hir/ssa.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/hir/ssa.cpp) when types are flowed.
...
[Jit/hir/optimization.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/hir/optimization.cpp), and run by
`jit::Compiler::runPasses` (see [Jit/compiler.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/compiler.cpp)).
...
[Jit/hir/refcount_insertion.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/hir/refcount_insertion.cpp); see
...
[Jit/lir/](https://github.com/facebookincubator/cinderx/tree/main/cinderx/Jit/lir/), and lowering to it is implemented in `jit::lir::Generator` in
[Jit/lir/generator.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/lir/generator.cpp). Currently HIR is turned into a
textual representation of LIR, which is then parsed into LIR instruction
objects (in [Jit/lir/block_builder.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/lir/block_builder.cpp)), though we aim
to eliminate the textual step.

## Register allocation and LIR optimizations

Register allocation is implemented in
[Jit/lir/regalloc.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/lir/regalloc.cpp). Other optimizations on LIR (some
before and some after register allocation) are also implemented in the
[Jit/lir/](https://github.com/facebookincubator/cinderx/tree/main/cinderx/Jit/lir/) directory. These are mostly coordinated in
...
[Jit/codegen/autogen.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/codegen/autogen.cpp) and
[Jit/codegen/gen_asm.cpp](https://github.com/facebookincubator/cinderx/blob/main/cinderx/Jit/codegen/gen_asm.cpp).
