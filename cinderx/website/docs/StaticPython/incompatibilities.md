...
description: "Dynamic Python patterns that Static Python discourages or disallows, with recommended alternatives."
sidebar_label: Programming Patterns
slug: /static-python/programming-patterns
---
...
To avoid having to declare an `__init__` method on the
