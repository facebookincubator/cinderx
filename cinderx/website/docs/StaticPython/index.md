---
title: Static Python
description: "Static Python is an alternative bytecode compiler and runtime extension that uses type annotations for Cython-level performance with no new syntax."
